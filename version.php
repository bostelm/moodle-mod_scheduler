 ...
 * It is intended for use with Moodle 2.3 and 2.4.
 */

$module->version  = 2012102804;       // The current module version (Date: YYYYMMDDXX)
$module->release  = '2.3.2';         // Human-friendly version name
