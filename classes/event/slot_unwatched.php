 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class slot_unwatched extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event_slotunwatched', 'scheduler');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' removed the user with id '{$this->relateduserid}' from the watchers of " .
