...
/* ***** Capabilities ****** */
$string['scheduler:addinstance'] = 'Ajouter un nouveau rendez-vous';
...
$string['deleteallunusedslots'] = 'Supprimer tous les créneaux non utilisés';
$string['deletemyslots'] = 'Supprimer tous mes propres créneaux';
...
$string['slotwarning'] = '<b>Attention : </b> Déplacer ce créneau à l\'heure voulue suppose supprimer le(s) créneau(x) suivant(s)...';
