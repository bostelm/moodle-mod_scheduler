...
$string['activitydate:bookingstart'] = 'Booking opens';
$string['activitydate:bookingend'] = 'Booking closes';
...
$string['bookingend'] = 'Booking end date';
$string['bookingended'] = 'The booking period ended on {$a}.';
$string['bookingend_help'] = 'If enabled, students can only book appointments until this date and time.';
$string['bookingendbeforestart'] = 'The booking end must be later than the booking start.';
...
$string['bookingnotopen'] = 'Booking appointments is not currently possible.';
$string['bookingnotstarted'] = 'Booking appointments will be possible from {$a}.';
$string['bookingperiod'] = 'Booking period';
$string['bookingstart'] = 'Booking start date';
$string['bookingstart_help'] = 'If enabled, students can only book appointments from this date and time onwards.';
