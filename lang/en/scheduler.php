...
<p><ul>
<li><strong>"One single appointment" mode:</strong> The student can only have a single appointment in this module. Once it has been seen by the teacher, he will not be allowed to apply for any further meeting. The only way to reset ability of a student to apply is to delete the old "seen" records.</li>
<li><strong>"One at a time" mode:</strong> The student can apply only to one (future) date. Once the meeting is over and concluded, he can appoint back. this mode is useful to arbitrate project appointments on long run projects, specially when multiple phases of appointments are to be offered.
</li>
</ul>
</p>';
