...
$string['appointmentsperpage'] = 'Appointments per page';
$string['appointmentsperpage_desc'] = 'The number of appointments to show per page in the teacher view when editing a slot. This can be helpful to reduce memory for slots with large numbers of appointments. Default of zero disables paging.';
