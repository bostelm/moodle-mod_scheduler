...
$string['slotvisibility'] = 'Member visibility of the slot';
$string['slotvisibility_help'] = 'Definition of the slot visibility option with which a new slot will be created.<br/><b>Anonymous:</b> The members of this slot are always invisible to all.<br/><b>Visible:</b> All members of this slot are always visible to all.<br/><b>Only visible to slot members:</b> Only slot members can see each other.';
...
$string['visibility'] = 'Default member visibility';
