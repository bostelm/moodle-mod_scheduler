...
function xmldb_scheduler_upgrade($oldversion=0) {
    ...
    if ($oldversion < 2020020300) {
        ...
        // Scheduler savepoint reached.
        upgrade_mod_savepoint(true, 2020020300, 'scheduler');
    }

    if ($oldversion < 2020020303) {
        ...
        // Scheduler savepoint reached.
        upgrade_mod_savepoint(true, 2020020303, 'scheduler');
    }

    if ($oldversion < 2020020304) {
        ...
        // Scheduler savepoint reached.
        upgrade_mod_savepoint(true, 2020020304, 'scheduler');
    }

    if ($oldversion < 2020020305) {
        ...
        // Scheduler savepoint reached.
        upgrade_mod_savepoint(true, 2020020305, 'scheduler');
    }
